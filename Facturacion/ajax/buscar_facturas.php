<?php
	...
	if (isset($_GET['id'])){
		...
		$del1="delete from factura where numero_factura='".$numero_factura."'";
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
         $q = mysqli_real_escape_string($con,(strip_tags($_REQUEST['q'], ENT_QUOTES)));
		  $sTable = "factura, cliente, users";
		 $sWhere = "";
		 $sWhere.=" WHERE factura.id_cliente=cliente.id_cliente and factura.id_vendedor=users.user_id";
		if ( $_GET['q'] != "" )
		{
		...
		$sWhere.=" order by factura.id_factura desc";
