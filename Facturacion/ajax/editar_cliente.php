<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$cedula_rnc=mysqli_real_escape_string($con,(strip_tags($_POST["mod_cedula_rnc"],ENT_QUOTES));
		$membresia=mysqli_real_escape_string($con,(strip_tags($_POST["mod_membresia"],ENT_QUOTES))));
		$estado=intval($_POST['mod_estado']);
		
		$id_cliente=intval($_POST['mod_id']);
		$sql="UPDATE cliente SET nombre_cliente='".$nombre."',apellido_cliente='".$apellido."', telefono='".$telefono."', email='".$email."', direccion='".$direccion."',cedula_rnc='".$cedula_rnc."' ,membresia='".$membresia."',status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'";
