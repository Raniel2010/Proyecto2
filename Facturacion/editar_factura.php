<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		$sql_factura=mysqli_query($con,"select $campos from factura, clientes where facturas.id_cliente=clientes.id_cliente and id_factura='".$id_factura."'");
		$count=mysqli_num_rows($sql_factura);
		if ($count==1)
		{
				$rw_factura=mysqli_fetch_array($sql_factura);
				$id_cliente=$rw_factura['id_cliente'];
				$nombre=$rw_factura['nombre_cliente'];
