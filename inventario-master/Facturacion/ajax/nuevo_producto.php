<?php
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO producto (codigo_producto, producto_nombre,categoria , marca , descripcion , status_producto, precio) VALUES ('$codigo','$nombre', '$categoria','$marca' ,'$descripcion' ,'$estado','$precio_venta')";
