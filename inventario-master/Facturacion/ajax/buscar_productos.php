...
/* Connect To Database*/
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('codigo_producto', 'producto_nombre');//Columnas de busqueda
		 $sTable = "producto";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $nombre_producto;?>" id="producto_nombre<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $categoria_producto?>" id="categoria<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $marca_producto?>" id="marca<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $descripcion_producto?>" id="descripcion<?php echo $id_producto;?>">
					
					<input type="hidden" value="<?php echo number_format($precio_producto,2,'.','');?>" id="precio<?php echo $id_producto;?>">
					<tr>
