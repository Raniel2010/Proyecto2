...
<?php
	$sumador_total=0;
	$sql=mysqli_query($con, "select * from producto, factura, detalle_factura where factura.numero_factura=detalle_factura.numero_factura and  facturas.id_factura='$id_factura' and products.id_producto=detalle_factura.id_producto");
	...
	$update=mysqli_query($con,"update factura set total_venta='$total_factura' where id_factura='$id_factura'");
?>
<tr>
