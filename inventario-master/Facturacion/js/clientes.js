 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var cedula_rnc_cliente = $("#cedula_cliente"+id).val();
			var membresia_cliente = $("#membresia_cliente"+id).val();
			...
			$("#mod_cedula_rnc").val(cedula_rnc_cliente);
			$("mod_membresia").val(membresia_cliente);
